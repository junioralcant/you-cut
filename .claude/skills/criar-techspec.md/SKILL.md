...
<critical>NÃO GERE A TECH SPEC SEM ANTES FAZER PERGUNTAS DE CLARIFICAÇÃO (USE ASK USER QUESTION TOOL)</critical>
...
- Template Tech Spec: .agents/skills/criar-techspec.md
